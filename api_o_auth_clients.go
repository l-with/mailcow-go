...
func (r ApiCreateOAuthClientRequest) Execute() (*CreateAlias200Response, *http.Response, error) {
...
func (a *OAuthClientsApiService) CreateOAuthClientExecute(r ApiCreateOAuthClientRequest) (*CreateAlias200Response, *http.Response, error) {
	var (
	...
	localVarPath := localBasePath + "/api/v1/add/oauth2-client"
...
func (r ApiDeleteOAuthClientRequest) DeleteOAuthClientRequest(deleteOAuthClientRequest DeleteOAuthClientRequest) ApiDeleteOAuthClientRequest {
	r.deleteOAuthClientRequest = &deleteOAuthClientRequest
	return r
}

func (r ApiDeleteOAuthClientRequest) Execute() (*CreateAlias200Response, *http.Response, error) {
...
*/
func (a *OAuthClientsApiService) DeleteOAuthClient(ctx context.Context) ApiDeleteOAuthClientRequest {
	return ApiDeleteOAuthClientRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
//  @return CreateAlias200Response
func (a *OAuthClientsApiService) DeleteOAuthClientExecute(r ApiDeleteOAuthClientRequest) (*CreateAlias200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localVarPath := localBasePath + "/api/v1/delete/oauth2-client"
	...
	// body params
	localVarPostBody = r.deleteOAuthClientRequest
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["ApiKeyAuth"]; ok {
...
// e.g. api-key-string
func (r ApiGetOAuthClientsRequest) XAPIKey(xAPIKey string) ApiGetOAuthClientsRequest {
	r.xAPIKey = &xAPIKey
	return r
}
...
*/
func (a *OAuthClientsApiService) GetOAuthClients(ctx context.Context, id string) ApiGetOAuthClientsRequest {
	return ApiGetOAuthClientsRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
func (a *OAuthClientsApiService) GetOAuthClientsExecute(r ApiGetOAuthClientsRequest) (*http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/get/oauth2-client/{id}"
