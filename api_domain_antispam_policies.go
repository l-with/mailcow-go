...
func (r ApiCreateDomainPolicyRequest) CreateDomainPolicyRequest(createDomainPolicyRequest CreateDomainPolicyRequest) ApiCreateDomainPolicyRequest {
	r.createDomainPolicyRequest = &createDomainPolicyRequest
	return r
}

func (r ApiCreateDomainPolicyRequest) Execute() (*CreateTimeLimitedAlias200Response, *http.Response, error) {
...
*/
func (a *DomainAntispamPoliciesApiService) CreateDomainPolicy(ctx context.Context) ApiCreateDomainPolicyRequest {
	return ApiCreateDomainPolicyRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *DomainAntispamPoliciesApiService) CreateDomainPolicyExecute(r ApiCreateDomainPolicyRequest) (*CreateTimeLimitedAlias200Response, *http.Response, error) {
	var (
	...
	localVarPath := localBasePath + "/api/v1/add/domain-policy"
	...
	// body params
	localVarPostBody = r.createDomainPolicyRequest
	if r.ctx != nil {
...
func (r ApiDeleteDomainPolicyRequest) DeleteDomainPolicyRequest(deleteDomainPolicyRequest DeleteDomainPolicyRequest) ApiDeleteDomainPolicyRequest {
	r.deleteDomainPolicyRequest = &deleteDomainPolicyRequest
	return r
}

func (r ApiDeleteDomainPolicyRequest) Execute() (*CreateTimeLimitedAlias200Response, *http.Response, error) {
...
*/
func (a *DomainAntispamPoliciesApiService) DeleteDomainPolicy(ctx context.Context) ApiDeleteDomainPolicyRequest {
	return ApiDeleteDomainPolicyRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
//  @return CreateTimeLimitedAlias200Response
func (a *DomainAntispamPoliciesApiService) DeleteDomainPolicyExecute(r ApiDeleteDomainPolicyRequest) (*CreateTimeLimitedAlias200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localVarPath := localBasePath + "/api/v1/delete/domain-policy"
	...
	// body params
	localVarPostBody = r.deleteDomainPolicyRequest
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["ApiKeyAuth"]; ok {
...
// e.g. api-key-string
func (r ApiListBlacklistDomainPolicyRequest) XAPIKey(xAPIKey string) ApiListBlacklistDomainPolicyRequest {
	r.xAPIKey = &xAPIKey
	return r
}

func (r ApiListBlacklistDomainPolicyRequest) Execute() (*http.Response, error) {
	return r.ApiService.ListBlacklistDomainPolicyExecute(r)
}
...
*/
func (a *DomainAntispamPoliciesApiService) ListBlacklistDomainPolicy(ctx context.Context, domain string) ApiListBlacklistDomainPolicyRequest {
	return ApiListBlacklistDomainPolicyRequest{
		ApiService: a,
		ctx:        ctx,
		domain:     domain,
...
func (a *DomainAntispamPoliciesApiService) ListBlacklistDomainPolicyExecute(r ApiListBlacklistDomainPolicyRequest) (*http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DomainAntispamPoliciesApiService.ListBlacklistDomainPolicy")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/get/policy_bl_domain/{domain}"
...
// e.g. api-key-string
func (r ApiListWhitelistDomainPolicyRequest) XAPIKey(xAPIKey string) ApiListWhitelistDomainPolicyRequest {
	r.xAPIKey = &xAPIKey
	return r
}

func (r ApiListWhitelistDomainPolicyRequest) Execute() (*http.Response, error) {
	return r.ApiService.ListWhitelistDomainPolicyExecute(r)
}
...
*/
func (a *DomainAntispamPoliciesApiService) ListWhitelistDomainPolicy(ctx context.Context, domain string) ApiListWhitelistDomainPolicyRequest {
	return ApiListWhitelistDomainPolicyRequest{
		ApiService: a,
		ctx:        ctx,
		domain:     domain,
...
func (a *DomainAntispamPoliciesApiService) ListWhitelistDomainPolicyExecute(r ApiListWhitelistDomainPolicyRequest) (*http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DomainAntispamPoliciesApiService.ListWhitelistDomainPolicy")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/get/policy_wl_domain/{domain}"
	localVarPath = strings.Replace(localVarPath, "{"+"domain"+"}", url.PathEscape(parameterToString(r.domain, "")), -1)
