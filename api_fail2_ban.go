...
type ApiEditFail2BanRequest struct {
	...
	editFail2BanRequest *EditFail2BanRequest
}

func (r ApiEditFail2BanRequest) EditFail2BanRequest(editFail2BanRequest EditFail2BanRequest) ApiEditFail2BanRequest {
	r.editFail2BanRequest = &editFail2BanRequest
	return r
}

func (r ApiEditFail2BanRequest) Execute() (*CreateTimeLimitedAlias200Response, *http.Response, error) {
...
*/
func (a *Fail2BanApiService) EditFail2Ban(ctx context.Context) ApiEditFail2BanRequest {
	return ApiEditFail2BanRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *Fail2BanApiService) EditFail2BanExecute(r ApiEditFail2BanRequest) (*CreateTimeLimitedAlias200Response, *http.Response, error) {
	var (
	...
	localVarPath := localBasePath + "/api/v1/edit/fail2ban"
	...
	// body params
	localVarPostBody = r.editFail2BanRequest
	if r.ctx != nil {
...
func (r ApiGetFail2BanConfigRequest) Execute() (*http.Response, error) {
	return r.ApiService.GetFail2BanConfigExecute(r)
}
...
*/
func (a *Fail2BanApiService) GetFail2BanConfig(ctx context.Context) ApiGetFail2BanConfigRequest {
	return ApiGetFail2BanConfigRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *Fail2BanApiService) GetFail2BanConfigExecute(r ApiGetFail2BanConfigRequest) (*http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "Fail2BanApiService.GetFail2BanConfig")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/get/fail2ban"
