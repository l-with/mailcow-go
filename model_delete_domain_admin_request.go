...
type NullableDeleteDomainAdminRequest struct {
	value *DeleteDomainAdminRequest
	isSet bool
}

func (v NullableDeleteDomainAdminRequest) Get() *DeleteDomainAdminRequest {
	return v.value
}

func (v *NullableDeleteDomainAdminRequest) Set(val *DeleteDomainAdminRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteDomainAdminRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteDomainAdminRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteDomainAdminRequest(val *DeleteDomainAdminRequest) *NullableDeleteDomainAdminRequest {
	return &NullableDeleteDomainAdminRequest{value: val, isSet: true}
}
