...
func (r ApiAddForwardHostRequest) Execute() (*CreateAlias200Response, *http.Response, error) {
...
func (a *FordwardingHostsApiService) AddForwardHostExecute(r ApiAddForwardHostRequest) (*CreateAlias200Response, *http.Response, error) {
	var (
...
func (r ApiDeleteForwardHostRequest) Execute() (*CreateAlias200Response, *http.Response, error) {
...
// Execute executes the request
//  @return CreateAlias200Response
func (a *FordwardingHostsApiService) DeleteForwardHostExecute(r ApiDeleteForwardHostRequest) (*CreateAlias200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
