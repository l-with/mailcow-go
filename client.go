...
// APIClient manages communication with the mailcow API API v1.0.0
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.AddressRewritingApi = (*AddressRewritingApiService)(&c.common)
	c.AliasesApi = (*AliasesApiService)(&c.common)
	c.AppPasswordsApi = (*AppPasswordsApiService)(&c.common)
	c.DKIMApi = (*DKIMApiService)(&c.common)
	c.DomainAdminApi = (*DomainAdminApiService)(&c.common)
	c.DomainAntispamPoliciesApi = (*DomainAntispamPoliciesApiService)(&c.common)
	c.DomainsApi = (*DomainsApiService)(&c.common)
	c.Fail2BanApi = (*Fail2BanApiService)(&c.common)
	c.FordwardingHostsApi = (*FordwardingHostsApiService)(&c.common)
	...
	c.OutgoingTLSPolicyMapOverridesApi = (*OutgoingTLSPolicyMapOverridesApiService)(&c.common)
	c.QuarantineApi = (*QuarantineApiService)(&c.common)
	c.QueueManagerApi = (*QueueManagerApiService)(&c.common)
	...
	c.SyncJobsApi = (*SyncJobsApiService)(&c.common)
...
func (c *APIClient) prepareRequest(
	...
	if postBody != nil {
		...
		// special for DeleteAlias
		if strings.HasSuffix(path, "/api/v1/delete/alias") {
			var deleteAliasRequest *DeleteAliasRequest = postBody.(*DeleteAliasRequest)
			postBody = *&deleteAliasRequest.Items
		}
		// special for DeleteDkim
		if strings.HasSuffix(path, "/api/v1/delete/dkim") {
			var deleteDkimRequest *DeleteDKIMKeyRequest = postBody.(*DeleteDKIMKeyRequest)
			postBody = *&deleteDkimRequest.Items
		}
		// special for DeleteSyncjob
		if strings.HasSuffix(path, "/api/v1/delete/syncjob") {
			var deleteSyncJobRequest *DeleteSyncJobRequest = postBody.(*DeleteSyncJobRequest)
			postBody = *&deleteSyncJobRequest.Items
		}
