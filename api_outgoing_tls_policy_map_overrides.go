...
func (r ApiCreateTLSPolicyMapRequest) Execute() (*CreateAlias200Response, *http.Response, error) {
...
func (a *OutgoingTLSPolicyMapOverridesApiService) CreateTLSPolicyMapExecute(r ApiCreateTLSPolicyMapRequest) (*CreateAlias200Response, *http.Response, error) {
	var (
...
func (r ApiDeleteTLSPolicyMapRequest) Execute() (*CreateAlias200Response, *http.Response, error) {
...
// Execute executes the request
//  @return CreateAlias200Response
func (a *OutgoingTLSPolicyMapOverridesApiService) DeleteTLSPolicyMapExecute(r ApiDeleteTLSPolicyMapRequest) (*CreateAlias200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
