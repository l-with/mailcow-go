...
func (r ApiCreateResourcesRequest) CreateResourcesRequest(createResourcesRequest CreateResourcesRequest) ApiCreateResourcesRequest {
	r.createResourcesRequest = &createResourcesRequest
	return r
}

func (r ApiCreateResourcesRequest) Execute() (*CreateTimeLimitedAlias200Response, *http.Response, error) {
...
*/
func (a *ResourcesApiService) CreateResources(ctx context.Context) ApiCreateResourcesRequest {
	return ApiCreateResourcesRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *ResourcesApiService) CreateResourcesExecute(r ApiCreateResourcesRequest) (*CreateTimeLimitedAlias200Response, *http.Response, error) {
	var (
	...
	localVarPath := localBasePath + "/api/v1/add/resource"
	...
	// body params
	localVarPostBody = r.createResourcesRequest
	if r.ctx != nil {
...
func (r ApiDeleteResourcesRequest) DeleteResourcesRequest(deleteResourcesRequest DeleteResourcesRequest) ApiDeleteResourcesRequest {
	r.deleteResourcesRequest = &deleteResourcesRequest
	return r
}

func (r ApiDeleteResourcesRequest) Execute() (*CreateTimeLimitedAlias200Response, *http.Response, error) {
...
*/
func (a *ResourcesApiService) DeleteResources(ctx context.Context) ApiDeleteResourcesRequest {
	return ApiDeleteResourcesRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
//  @return CreateTimeLimitedAlias200Response
func (a *ResourcesApiService) DeleteResourcesExecute(r ApiDeleteResourcesRequest) (*CreateTimeLimitedAlias200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localVarPath := localBasePath + "/api/v1/delete/resource"
	...
	// body params
	localVarPostBody = r.deleteResourcesRequest
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["ApiKeyAuth"]; ok {
...
func (a *ResourcesApiService) GetResourcesExecute(r ApiGetResourcesRequest) (*http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/get/resource/all"
